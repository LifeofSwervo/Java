...
public class BankSystemRunner {
    public static void main(String[] args)
    {
        ...
        accounts.add(new BankAccount("Steve", "Rodgers", "123584", 100.0, "Checking"));
        accounts.add(new BankAccount("Tony", "Stark", "458416", 250000.0, "Checking"));
        accounts.add(new BankAccount("Bruce", "Banner", "896231", 13674.32,"Savings"));
    ...
    public static void addAccount(Scanner input, ArrayList<BankAccount> accounts)
    {
        ...
        BankAccount newAccount = new BankAccount(firstName, lastName, accountNum, balance, type);
